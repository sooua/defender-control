...
pub fn get_strings() -> Strings {
    match current_lang() {
        Lang::Zh => Strings {
            ...
            msg_disable_ok: "Windows Defender 已成功关闭！建议重启系统。",
            msg_enable_ok: "Windows Defender 已成功开启！建议重启系统。",
            msg_ti_fail: "权限提升失败: ",
            msg_op_fail: "操作失败: ",
            msg_op_panic: "操作异常终止",
        ...
        Lang::Ja => Strings {
            ...
            msg_disable_ok: "Windows Defender は正常に無効化されました。再起動をお勧めします。",
            msg_enable_ok: "Windows Defender は正常に有効化されました。再起動をお勧めします。",
            msg_ti_fail: "権限昇格に失敗: ",
            msg_op_fail: "操作に失敗: ",
            msg_op_panic: "操作が異常終了しました",
            msg_watch_removed: "復元防止タスクを削除しました",
            msg_watch_installed: "復元防止タスクをインストールしました（起動時に自動チェック）",
            error_title: "エラー",
            confirm_title: "操作の確認",
        ...
        Lang::Ko => Strings {
            ...
            msg_disable_ok: "Windows Defender가 성공적으로 비활성화되었습니다. 재부팅을 권장합니다.",
            msg_enable_ok: "Windows Defender가 성공적으로 활성화되었습니다. 재부팅을 권장합니다.",
            msg_ti_fail: "권한 상승 실패: ",
            msg_op_fail: "작업 실패: ",
            msg_op_panic: "작업이 비정상 종료되었습니다",
            msg_watch_removed: "복구 방지 작업이 제거되었습니다",
            msg_watch_installed: "복구 방지 작업이 설치되었습니다 (시작 시 자동 확인)",
            error_title: "오류",
            confirm_title: "작업 확인",
        ...
        _ => Strings {
            ...
            msg_disable_ok: "Windows Defender has been disabled. Reboot recommended.",
            msg_enable_ok: "Windows Defender has been enabled. Reboot recommended.",
